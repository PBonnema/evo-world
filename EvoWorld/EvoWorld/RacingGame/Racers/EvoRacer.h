...
class EvoRacer final : public Racer
{
public:
    EvoRacer(const Vector2<double>& position, double mass, double radius);

    Vector2<double> next_move(const RacingGame& game, const std::chrono::high_resolution_clock::time_point& now,

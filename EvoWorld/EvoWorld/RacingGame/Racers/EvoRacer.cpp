...
EvoRacer::EvoRacer(const Vector2<double>& position, const double mass, const double radius) :
...
Vector2<double> EvoRacer::next_move(const RacingGame& game, const std::chrono::high_resolution_clock::time_point& now,
